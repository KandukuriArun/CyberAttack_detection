...
--
-- Database: `trustworthy_and_reliable_deep_learning`
--
CREATE DATABASE IF NOT EXISTS `trustworthy_and_reliable_deep_learning` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `trustworthy_and_reliable_deep_learning`;
...
('05592oog6pq7uzlbdw3gmd7nsc7jq9do', 'eyJ1c2VyaWQiOjJ9:1qZAoB:SZVcjZZSjvU3UKxGtxlgD807Ixn40v8wf_nqlBg7yJM', '2023-09-07 13:55:35.913247'),
...
('ulb7u2as14kx7ag57nnwezj8nk9afnp6', 'eyJ1c2VyaWQiOjF9:1qZ9TT:K-W8YzjFNyEy3zb8CQvDYKgN6i6owAgi0TNJ-fZaGiI', '2023-09-07 12:30:07.981230'),
...
--
-- Table structure for table `remote_user_cyberattack_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_cyberattack_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_cyberattack_detection`
--

INSERT INTO `remote_user_cyberattack_detection` (`id`, `Fid`, `Protocol`, `Flag`, `Packet`, `Sender_ID`, `Receiver_ID`, `Source_IP_Address`, `Destination_IP_Address`, `Source_Port`, `Destination_Port`, `Packet_Size`, `Prediction`) VALUES
(1, '10.42.0.211-23.21.95.195-40799-443-6', 'TCP', 'SYN', 'SMTP', '789012', '345678', '10.0.0.2', '192.168.1.10', '25', '12345', '512', 'Cross Site Scripting'),
(2, '172.217.12.195-10.42.0.211-443-44833-6', 'UDP', 'ACK', 'DNS', '901234', '678901', '10.0.0.15', '192.168.0.2', '12345', '53', '256', 'Password Attacks'),
(3, '10.42.0.151-74.125.22.138-43684-443-6', 'UDP', 'ACK', 'SNMP', '901234', '678901', '10.0.0.15', '192.168.1.10', '161', '12345', '768', 'DoS'),
(4, '203.205.158.63-10.42.0.151-80-51961-6', 'UDP', 'ACK', 'NTP', '456789', '234567', '10.0.0.8', '192.168.0.5', '123', '12345', '128', 'Cross Site Scripting');
...
(9, 'Deep Neural Network-DNN', '31.333333333333336'),
(10, 'SVM', '36.0'),
(11, 'Logistic Regression', '40.0'),
(12, 'Decision Tree Classifier', '40.0');
...
(19, 'Cross Site Scripting', '50.0'),
(20, 'DoS', '25.0'),
(21, 'Password Attacks', '25.0');
